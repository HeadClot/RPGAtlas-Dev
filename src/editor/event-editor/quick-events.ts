/* RPGAtlas — src/editor/event-editor/quick-events.ts
   ...
   Villager / Shopkeeper / Innkeeper / Locked Door) from a single small dialog
   without opening the full event editor. Each template generates ordinary
   pages and commands, so beginners can open the result afterwards and see
